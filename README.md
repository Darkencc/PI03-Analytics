...
## Introducción
Proyecto individual de data science. En esta ocasión, teniendo en cuenta los conocimientos básicos del ecosistema de criptomonedas para luego realizar una DEMO en vivo del dashboard como entregable.
...
* Se debe trabajar directamente con conexión a la API. Es decir que el trabajo no puede estar montado a partir de archivos csv o de entorno local. 
* Se puede realizar la investigación en Jupyter (u otro ambiente) para análizar todo lo que consideren necesario. La entrega es opcional.
* Se debera elegir 10 criptomonedas para el reporte. Se recomienda utilizar [coinmarketcap.com ](https://coinmarketcap.com/es/) para su elección.

#### El Dashboard puede armarse en PowerBI o Streamlit. Elegir una herramienta que genere valor agregado a sus proyectos y experiencia a futuro. Este mismo deberá contar con:
...
#### Presentación.
* La presentación se hará en meets previamente coordinados de 15 minutos. El Mentor es el encargado de decidir los horarios.
* Su presentación no deberá extenderse de los 10 minutos respetando los horarios acordados, para poder recibir el feedback correspondiente.
